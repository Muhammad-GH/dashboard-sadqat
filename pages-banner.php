...
$event_archive_title = (isset($borntogive_options['events_archive_title']))?$borntogive_options['events_archive_title']:esc_html__('Events', 'borntogive');
$blog_archive_title = (isset($borntogive_options['blog_archive_title']))?$borntogive_options['blog_archive_title']:esc_html__('Blog', 'borntogive');
$causes_archive_title = (isset($borntogive_options['causes_archive_title']))?$borntogive_options['causes_archive_title']:esc_html__('Causes', 'borntogive');
$team_archive_title = (isset($borntogive_options['team_archive_title']))?$borntogive_options['team_archive_title']:esc_html__('Team', 'borntogive');
$shop_archive_title = (isset($borntogive_options['shop_archive_title']))?$borntogive_options['shop_archive_title']:esc_html__('Shop', 'borntogive');
...
elseif($post_type=='post')
{
	...
	elseif((is_home() || is_archive()) && ($blog_archive_title == '%author%' || $blog_archive_title == '%category%')){
		$blog_title = esc_html__('Blog', 'borntogive');
	}
	else{
		$blog_title = $blog_archive_title;
	}
