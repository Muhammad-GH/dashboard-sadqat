    ...
    <div class="container">
      <div class="row">
        <div class="col-md-<?php echo esc_attr($class); ?>" id="content-col">
          ...
          <ul class="pager margin-40"> <li><?php echo previous_post_link('%link', esc_html__('&laquo; Prev Post', 'borntogive')); ?></li><li><?php echo next_post_link('%link', esc_html__('Next Post &raquo;', 'borntogive')); ?></li></ul>
          <?php 
		  endwhile;
		   endif; ?>
